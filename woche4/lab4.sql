...
GRANT SELECT ON CRM_TEAM TO DBARC3_ROLE_ADMIN;
-- Eigentlich könnte hier auch eine eigene view für das crm erstellt werden, so dass
-- man nur sich selber sieht. Das Select ist aber notwendig um später die VIEW für die eigenen Länder nutzen zu können.
